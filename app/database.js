...
database.exec("CREATE TABLE IF NOT EXISTS media (id INTEGER PRIMARY KEY AUTOINCREMENT, path TEXT, imdb_id TEXT, stream_title TEXT, type TEXT, file_type TEXT, stream_language TEXT, stream_resolution TEXT, size INTEGER, mtime DATE, collection_id INTEGER, episode INTEGER, season INTEGER);");
